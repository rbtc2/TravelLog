...
export class CountrySelector {
    ...
    unwatchFromZIndexManager() {
        if (window.zIndexManager) {
            try {
                ...
                console.log('CountrySelector z-index-manager unwatch 완료');
            } catch (error) {
                console.warn('CountrySelector z-index-manager unwatch 실패:', error);
            }
        }
    }
    ...
    forceClose() {
        ...
        try {
            ...
            console.log('CountrySelector 강제 닫기 완료');
        } catch (error) {
            console.error('CountrySelector 강제 닫기 실패:', error);
        }
    }
}
